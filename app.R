...
pubs_file <- file.path(base_dir, "publications", "publications_from_orcid.csv")
pubyear_file  <- file.path(base_dir, "citations", "citations_by_publication_year.csv")
cityear_file  <- file.path(base_dir, "citations", "citations_by_citation_year.csv")
cityear_paper_file <- file.path(base_dir, "citations", "citations_by_citation_year_by_paper.csv")
